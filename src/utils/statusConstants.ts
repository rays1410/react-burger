...
export const ERR_USER_RESET_PASSWORD =
  "Не удалось изменить пароль. Попробуйте ещё раз";
export const ERR_EMAIL_RESET =
...
export const SUCC_PASSWORD_CHANGE = "Вы успешно изменили пароль!";
export const SUCC_EMAIL_SENT = "Письмо отправлено на указанную почту";
